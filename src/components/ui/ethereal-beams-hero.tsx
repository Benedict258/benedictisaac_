...
const teamAvatars = [
  {
    initials: "BI",
    src: "https://images.unsplash.com/photo-1502685104226-ee32379fefbe?auto=format&fit=facearea&w=96&h=96&q=80",
  },
  {
    initials: "UX",
  ...
  {
    initials: "PM",
    src: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=facearea&w=96&h=96&q=80",
  },
  {
    initials: "QA",
    src: "https://images.unsplash.com/photo-1527980965255-d3b416303d12?auto=format&fit=facearea&w=96&h=96&q=80",
  },
];

const stats = [
  { label: "IN CLIENT REVENUE GENERATED", value: "$5M+" },
  { label: "BUSINESSES LAUNCHED", value: "200+" },
  { label: "SAVED IN OPERATIONAL COSTS", value: "$500K+" },
];
  ...
  return (
    <div className="flex -space-x-3">
      {teamAvatars.map((member, i) => (
        <div
          className="h-12 w-12 border-2 border-primary bg-neutral-800 rounded-full overflow-hidden"
          key={member.initials}
...
function StatsMarquee() {
  return (
    <div className="border-white/10 border-y bg-black/30 py-2 backdrop-blur-sm">
...
export default function EtherealBeamsHero({
  ...
  const openGitHub = () => {
    window.open("https://github.com/Benedict258/", "_blank", "noreferrer");
  };
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            <div className="flex items-center">
              <span className="text-xl font-bold text-white">Benedict Isaac</span>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <Button size="sm" onClick={scrollToProjects}>
                View Projects
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mb-10 text-lg leading-8 text-white/80 sm:text-xl lg:text-2xl max-w-3xl mx-auto">
              Full Stack and AI developer crafting fast, scalable systems that turn
              ambitious ideas into reliable products.
            </p>

            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
              <Button size="lg" className="shadow-2xl shadow-white/25 font-semibold" onClick={scrollToProjects}>
                Start a Project
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-2xl mx-auto">
              <div className="text-center">
                ...
                <div className="text-white/60 text-sm">Products shipped</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-white mb-2">8+</div>
                <div className="text-white/60 text-sm">Teams supported</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-white mb-2">100%</div>
                <div className="text-white/60 text-sm">Mission focus</div>
              </div>
            </div>
