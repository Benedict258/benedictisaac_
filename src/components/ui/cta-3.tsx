...
export function CallToAction() {
  return (
    <div className="relative mx-auto flex w-full max-w-3xl flex-col justify-between gap-y-6 border-y bg-[radial-gradient(35%_80%_at_25%_0%,rgba(255,255,255,0.08),transparent)] dark:bg-[radial-gradient(35%_80%_at_25%_0%,rgba(0,0,0,0.35),transparent)] px-4 py-8">
      <PlusIcon
      ...
      <div className="space-y-1">
        ...
        <p className="text-center text-muted-foreground">
          Start a collaboration today, let’s work together as allies to turn ideas into real results.
        </p>
      </div>
